...
tmux bind-key -n C-M-h if-shell "$is_vim" "send-keys C-h" "select-pane -L"
tmux bind-key -n C-M-j if-shell "$is_vim" "send-keys C-j" "select-pane -D"
tmux bind-key -n C-M-k if-shell "$is_vim" "send-keys C-k" "select-pane -U"
tmux bind-key -n C-M-l if-shell "$is_vim" "send-keys C-l" "select-pane -R"
